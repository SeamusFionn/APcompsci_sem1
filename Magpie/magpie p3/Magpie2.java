...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "whaddup with ur family?";
		}
		...
		{
			response = "yoooooooo I want a pet, tell me more";
		}
	...
	private String transformIWantStatement(String statement)
	{
	   ...
	   * return "What would it mean to" + restOfStatement; **/
		...
		int psn = findKeyword(a, "i want", 0);
		String restOfStatement = a.substring(psn + 6).trim();
	...
	*/
	private String transformYouMeStatement(String statement)
	{
	   ...
	   * */
		...
		int psnOfYou = findKeyword(a, "you");
		int psnOfMe = findKeyword(a, "me");
		String restOfStatement = a.substring(psnOfYou + 3, psnOfMe).trim();
	...
	private String transformIYouStatement(String statement)
	{
		...
		int psnOfI = findKeyword (a, "i", 0);
		int psnOfYou = findKeyword (a, "you");
		
		String restOfStatement = a.substring(psnOfI + 1, psnOfYou).trim();
